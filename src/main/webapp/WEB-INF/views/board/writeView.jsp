	...
	<script type="text/javascript">
		...
		function fn_addFile(){
			...
			$(".fileAdd_btn").on("click", function(){
				$("#fileIndex").append("<div><input type='file' style='float:left;' name='file_"+(fileIndex++)+"'>"+"</button>"+"<button type='button' class='fileAdd_btn btn btn-danger' style='float:right;' id='fileDelBtn'>"+"삭제"+"</button></div>");
			});
							...
							<c:if test="${member.userId != null}">
								...
								<tr><td>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea id="content" name="content" class="form-control" title="내용을 입력하세요." rows="10px"></textarea>
										</div>
									</div>
								</td></tr>
								<tr><td>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" id="writer" name="writer" class="form-control" title="작성자를 입력하세요." value="${member.userId}" />
										</div>
									</div>
								</td></tr>
								<tr>
